...
We do have a new implementation of the same FoMo model at https://github.com/Riadsala/FoMo. V1.0 is exactly the same mathematically as the version in the current repository, but has slightly tidied up code. 
