...
expName = 'foraging_expt_polygons_hard_AB'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='D:\\Dropbox\\CurrentResearch\\Foraging_simple\\foraging_rr\\feature_conjunction_version\\foraging_expt_polygons_hard_AB_lastrun.py',
...
text = visual.TextStim(win=win, name='text',
    text='Click on all the red square and green circle targets.\n\nClick to continue.',
    font='Open Sans',
...
polygon_38 = visual.Rect(
    win=win, name='polygon_38',
    width=(0.04, 0.04)[0], height=(0.04, 0.04)[1],
    ori=0.0, pos=[0,0],
    lineWidth=1.0,     colorSpace='rgb',  lineColor='lime', fillColor='lime',
    opacity=None, depth=-37.0, interpolate=True)
polygon_39 = visual.Rect(
    win=win, name='polygon_39',
    width=(0.04, 0.04)[0], height=(0.04, 0.04)[1],
    ori=0.0, pos=[0,0],
    lineWidth=1.0,     colorSpace='rgb',  lineColor='lime', fillColor='lime',
    opacity=None, depth=-38.0, interpolate=True)
polygon_40 = visual.Rect(
    win=win, name='polygon_40',
    width=(0.04, 0.04)[0], height=(0.04, 0.04)[1],
    ori=0.0, pos=[0,0],
    lineWidth=1.0,     colorSpace='rgb',  lineColor='lime', fillColor='lime',
        ...
        for clicked_shape in stimuli:
            if mouse.isPressedIn(clicked_shape):
                ...
                if (thisClickTime - lastClickTime) > bufferTime:
                    if clicked_shape.fillColor[0] == 1 and clicked_shape.fillColor[1] == -1 and len(clicked_shape.vertices) == 4: # red square
                        clicked_shape.color = 'grey'
                        points = points + 1
                        trial_points = trial_points + 1
                    elif clicked_shape.fillColor[1] == 1 and clicked_shape.fillColor[0] == -1 and len(clicked_shape.vertices) == 99: #lime circle
                        clicked_shape.color = 'grey'
                        points = points + 1
                        trial_points = trial_points + 1
                    else: 
