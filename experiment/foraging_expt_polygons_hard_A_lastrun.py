...
expName = 'foraging_expt_polygons_hard_A'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='D:\\Dropbox\\CurrentResearch\\Foraging_simple\\foraging_rr\\feature_conjunction_version\\foraging_expt_polygons_hard_A_lastrun.py',
